    ...
    <main className="mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="mt-8">
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <div className="flex flex-nowrap gap-4">
              <Slider
                ...
                step={1}
              />
              <div className="flex h-8 w-12 items-center justify-center rounded bg-white dark:bg-gray-950 text-sm font-medium border border-gray-300 dark:border-gray-800 text-gray-900 dark:text-gray-50">
          ...
          >
            <p className="text-gray-700 dark:text-gray-300 sm:text-sm">Estimated monthly cost</p>
            <p className="sm:text-2xl text-3xl font-medium text-gray-900 dark:text-gray-50">
              {calculatePrice()}
            </p>
          </Card>
