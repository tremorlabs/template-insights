          ...
          >
            ...
            >
              {Object.keys(regionOptions).map((provider) => {
                const Icon = cloudProviderIcons[provider as keyof typeof cloudProviderIcons]
                return (
          ...
          >
            ...
            <div className="flex flex-nowrap gap-4">
              <Slider
                ...
                step={1}
              />
              <div className="flex h-8 w-10 items-center justify-center rounded bg-white text-sm font-medium border border-gray-300 dark:border-gray-800 text-gray-900 dark:text-gray-50">
