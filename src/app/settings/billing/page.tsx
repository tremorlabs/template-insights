                    ...
                    <div className="md:col-span-2">
                        ...
                        <TableRoot className="mt-4">
                            <Table className="border-transparent dark:border-transparent">
                                <TableCaption className="text-left text-xs">¹Includes 10,000 trackable expenses/month, USD 0.10 for each additional expense.</TableCaption>
                                <TableHead>
                                    <TableRow>
                ...
                <div className="grid grid-cols-1 gap-x-14 gap-y-8 md:grid-cols-3">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <form className="mt-6 space-y-4">
                            <div>
                                <Label className="font-medium">Adress line 1</Label>
                                <Input
                            ...
                            <div>
                                <Label className="font-medium">Adress line 2</Label>
                                <Input
