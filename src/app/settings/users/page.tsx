                  ...
                  {users.map((item) => (
                    <TableRow key={item.name}>
                      <TableCell className="w-full">
                        {item.status === "pending" ? (
                          <div className="flex items-center gap-4">
                            <span className="inline-flex size-9 items-center justify-center rounded-full border border-dashed border-gray-300 p-1.5 text-xs font-medium text-gray-700 dark:border-gray-700">
                              {item.initials}
                            </span>
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                <span className="rounded-md bg-gray-100 px-1.5 py-0.5 text-xs font-medium text-gray-600 dark:text-gray-300">
                                  pending
                                </span>
                              </div>
                          ...
                          <div className="flex items-center gap-4">
                            <span className="inline-flex size-9 items-center justify-center rounded-full border border-gray-300 bg-gray-50 p-1.5 text-xs font-medium text-gray-700 dark:border-gray-700">
                              {item.initials}
                            </span>
                            <div>
                              <div className="text-sm font-medium text-gray-900 dark:text-gray-50">
