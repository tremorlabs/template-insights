...
const LegendItem = ({
    ...
    return (
        <li
            className={cx(
                // base
                "group inline-flex flex-nowrap items-center gap-1.5 whitespace-nowrap rounded pl-2 pr-1 py-1 transition",
                hasOnValueChange
        ...
        >
            <button className="inline-flex items-center gap-2 group">
                ...
                <RiCloseLine className="-ml-0.5 size-3.5 text-gray-500 group-hover:text-gray-900 shrink-0" aria-hidden={true} />
            </button>
        </li>
    )
}
