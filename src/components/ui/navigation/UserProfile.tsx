        ...
        <DropdownUserProfile>
            <Button
                ...
                className={cx(
                    ...
                    focusRing,
                    "group flex w-full items-center rounded-md px-1 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200/50 data-[state=open]:bg-gray-200/50 hover:dark:bg-gray-800/50 data-[state=open]:dark:bg-gray-800/50",
                )}
            >
                {isCollapsed ? (
                    ...
                    <span className="flex items-center gap-3">
                        ...
                        <span className={cx(isCollapsed ? "hidden" : "block")}>Emma Stone</span>
                    </span>
                )}
                {!isCollapsed && (
                    <ChevronsUpDown
    ...
    return (
        <DropdownUserProfile align="end">
            <Button
                ...
                variant="ghost"
                className={cx(
                    "group flex items-center rounded-md p-1 text-sm font-medium text-gray-900 hover:bg-gray-200/50 data-[state=open]:bg-gray-200/50 hover:dark:bg-gray-800/50 data-[state=open]:dark:bg-gray-800/50",
                )}
            >
                <span
