...
const activity = [
    { id: 1, type: 'edited', person: { name: 'Christopher Kindl' }, date: '7d ago', dateTime: '2023-01-23T10:32' },
    { id: 2, type: 'submitted', person: { name: 'Christopher Kindl' }, date: '6d ago', dateTime: '2023-01-23T11:03' },
    {
        id: 3,
        type: 'commented',
        person: {
            name: 'Chelsea Hagon (Trewitax)',
            imageUrl:
    ...
    { id: 4, type: 'approved', person: { name: 'Christopher Kindl' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
]
            ...
            <ul role="list" className="space-y-6">
                {activity.map((activityItem, activityItemIdx) => (
                    <li key={activityItem.id} className="relative flex gap-x-4">
                        ...
                        ) : activityItem.type === 'submitted' || activityItem.type === 'edited' ? (
                            <>
                                ...
                                <p className="flex-auto py-0.5 text-xs leading-5 text-gray-500">
                                    ...
                                    {activityItem.type === 'submitted' && (
                                        <>
                                            for approval by <span className="font-medium">Trewitax</span>.
                                        </>
                                    )}
                                </p>
                                <time dateTime={activityItem.dateTime} className="flex-none py-0.5 text-xs leading-5 text-gray-500">
