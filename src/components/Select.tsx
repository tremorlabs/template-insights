...
const selectTriggerStyles = [
    cx(
        // base
        "group/trigger flex w-full select-none items-center justify-between gap-3 truncate rounded-md border px-2.5 py-1.5 shadow-sm outline-none transition text-sm",
        // border color
